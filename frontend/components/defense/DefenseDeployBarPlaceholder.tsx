...
export const TOWER_UNITS: TowerUnit[] = [
  ...
  { id: "capybara",  image: require("../../assets/images/defence/debuff_tower.png"),          cost: getTowerPlaceCost("capybara") },
  { id: "fox",       image: require("../../assets/images/defence/wide_tower.png"),            cost: getTowerPlaceCost("fox") },
  { id: "red_panda", image: require("../../assets/images/defence/strong_single_tower.png"),   cost: getTowerPlaceCost("red_panda") },
  { id: "ginipig",   image: require("../../assets/images/defence/rapid_single_tower.png"),     cost: getTowerPlaceCost("ginipig") },
];
...
export default function DefenseDeployBarPlaceholder({
  ...
  const chipSize = chipSizeProp ?? Math.round(80 * DEFENSE_TOWER_IMAGE_SCALE);
