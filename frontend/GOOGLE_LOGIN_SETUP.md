...
2. ✅ **안드로이드 클라이언트 ID** - Android 타입 (패키지: `com.idog.googlelogin`)
3. ✅ **iOS 클라이언트 ID** - iOS 타입 (번들 ID: `com.idog.googlelogin`)
...
**참고**: Android와 iOS가 동일한 패키지/번들 ID (`com.idog.googlelogin`)를 사용하므로 일관성이 유지됩니다.
